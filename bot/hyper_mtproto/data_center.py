...
class DataCenter:
    ...
    @classmethod
    def get(cls, dc_id: int, test_mode: bool, ipv6: bool = False, media: bool = False) -> tuple:
        if test_mode:
            if ipv6:
...
def get_dc_address(dc_id, test_mode=False, ipv6=False, media=False):
    return DataCenter.get(dc_id, test_mode, ipv6, media)
